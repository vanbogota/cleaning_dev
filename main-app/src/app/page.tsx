  ...
  return <>
    ...
    <footer className={`footer`}>
      ...
      <div className={`container ${styles.footer__container} ${styles.footer__container_bottom}`}>
        <h4>{TextVariables.companyName}</h4>
        <p className={`text text_size_s text_marging_left`}>Designed by <span className="span_color_blue">BRIX Templates</span> - Edited by <a href="https://www.linkedin.com/in/ivan-bogdanov-dev/" target="_blank" className="span_color_blue">Ivan Bogdanov</a></p>
      </div>
    </footer>
  </>;
}
